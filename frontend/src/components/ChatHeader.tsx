...
const ChatHeader:React.FC<ChatHeaderProps> = ({showParticipants,setShowParticipants, currentRoom}) => {
  return (
    <>
    <Button
            ...
            {currentRoom ? (
                    <div className="flex gap-x-2 items-center  ">
                        <div>
                            ...
                            <h2 className="text-gray-400 text-sm">{currentRoom.owner.username}</h2>
                            <Crown fill="yellow" /> 
                            </div>
                        </div>
                    </div>
