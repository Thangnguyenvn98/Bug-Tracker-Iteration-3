...
const ChatInput:React.FC<ChatInputProps> = ({roomId,username,currentRoom,socket,isConnected,message,setMessage}) => {
      ...
      <div className="flex flex-col">
        {imageUrl && (
          <div className="relative mb-2">
            <img src={imageUrl} alt="Uploaded" className="max-w-[150px] h-auto object-cover rounded" />
            <button
              type="button"
        ...
        <div className="flex items-end">
          <EmojiPicker onChange={(emoji: string) => setMessage((prev) => `${prev} ${emoji}`)} />
          <Input
